  ...
  it("Should add tier data", async function() {
    ...
    */
    ...
    let Tier1 = {
      ...
      hashes: ['QmZwLzEXRj1AkUUnXRTzJ9gNmNpEYikK8CA2BF3iR6bRy7',
    ...
    let Tier2 = {
      ...
      hashes: [ 'QmNg9Y1U9GcvmhcuDgRqLYTV9buW3VkdcrgbDvGdQXZ451',
    ...
    expect(tokenURIHash).to.equal("QmeL8KzMzHXgMUXWNEjTk5aWbWvHWqjmbpE8AjE47p366e");
   
    let tokenContributionAsset = await dictionaryContract.tokenContributionAsset('0')
    expect(tokenContributionAsset).to.equal("0xEeeeeEeeeEeEeeEeEeEeeEEEeeeeEeeeeeeeEEeE");
   
    let tokenContributionSize = await dictionaryContract.tokenContributionSize('0')
